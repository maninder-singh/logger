/*
* Implementation of Murmur hashing algorithm has been taken from Valentin Vasilyev Fingerprintjs2 2.0.0
...
const _murmurHash3 = (key,seed) => {
    key = key || '';
    seed = seed || 0;
    let remainder = key.length % 16;
    let bytes = key.length - remainder,i;
    let h1 = [0, seed];
    let h2 = [0, seed];
    let k1 = [0, 0];
    let k2 = [0, 0];
